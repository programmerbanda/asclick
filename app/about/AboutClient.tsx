    ...
    <div className="overflow-x-hidden bg-white dark:bg-[#0f0f12] text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <section className="pt-24 pb-8 px-6 text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-gray-600 dark:text-gray-400 text-sm">
          A cinematic journey of emotions, artistry, and timeless wedding
          storytelling.
        </p>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.7 }}
          >
            <h2 className="text-3xl font-semibold mb-6">Meet Amit Singh</h2>

            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              Founder of ASCLICK, Amit Singh is a passionate wedding
              photographer with over 8 years of experience in crafting timeless
              love stories. What began as a creative curiosity soon evolved into
              a lifelong commitment to documenting emotions in their purest
              form. Amit believes that wedding photography is not just about
              taking pictures — it is about preserving moments that families
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed mb-6">
              ...
              atmosphere that makes each celebration unique. From quiet,
              intimate ceremonies to grand destination weddings, Amit approaches
              every project with the same dedication, precision, and artistic
              vision.
            </p>

            <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
              Over the years, he has worked with hundreds of couples across
              diverse locations, building a reputation for professionalism,
              creativity, and reliability. For Amit, photography is more than a
              profession — it is a responsibility to transform fleeting moments
              into timeless visual memories that tell a story long after the
      ...
      <section className="py-20 px-6 bg-gray-50 dark:bg-[#15151a]">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-semibold mb-12">Behind The Scenes</h2>
